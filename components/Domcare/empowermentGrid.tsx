        ...
        <section className="bg-[#FAFAFD] py-16 px-4">
            ...
            <div className="max-w-7xl mx-auto grid gap-6 md:grid-cols-2">
                ...
                <AnimateOnScroll type="fade-up">
                    <div className="relative h-[400px] md:h-[630px] rounded-xl overflow-hidden ">
                        <img
                            src={cards[0].image}
                            alt={cards[0].title}
                        ...
                        <div className="absolute inset-0 bg-black/60 p-6 flex flex-col items-center justify-center text-white text-center">
                            ...
                            {cards[0].hasButton && (
                                <button className="mt-6 bg-sky-500 hover:bg-sky-600 text-white text-sm font-semibold px-6 py-2 rounded">
                                    Enquire Now →
                                </button>
                            )}
                        </div>
                ...
                <div className="grid grid-cols-1 gap-6 ">
                    <AnimateOnScroll type="fade-up">
                        {cards.slice(1).map((card, index) => (
                            <div key={index} className="relative h-[250px] md:h-[300px] rounded-xl overflow-hidden  mt-3">
                                <img
                                    src={card.image}
                                    alt={card.title}
                                    className="object-cover w-full h-full"
